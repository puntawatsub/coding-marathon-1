...
- **Areas for Improvement**
  ...
  - should have used an object to manage state.
  - better styling
  - add in functions for duplicates .
  - form validation

- **Action Plan**
  - Outline specific steps to address the areas for improvement.
  - next time, I will be using an object to manage state.Could have form validation

## 5. Additional Notes

- Next time , should have form validations.
