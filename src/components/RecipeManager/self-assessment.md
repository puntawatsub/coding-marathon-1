...
- **Action Plan**
  - Outline specific steps to address the areas for improvement.
    - Next time I will write better styling.
    - I will handle duplicate values
    - I will write better form validation

## 5. Additional Notes

- Add any other relevant observations or feedback about the component.
  - The styling doesn't look clean
  - A simple text can be used as a cooking time, bad validation
